		...
		<table>
			<tr>
				...
				<td><input type="text" name="userid" size="10" id="userid">
					...
					<input type="button" value="중복체크" id="btnIdCheck" class="btn btn-dark">
				</td>
			</tr>
			<tr>
				<th>비밀번호</th>
			...
			<tr>
				<th rowspan="3">주소</th>
				<td><input type="text" name="zip" size="5"><button id="btnAddrFind" class="btn btn-dark">주소찾기</button> </td>
			</tr>
			<tr>
			...
			<tr>
				<th>사진</th>
				<td><input type="file" name="imgfile" id="imgfile" class="btn btn-dark">
			...
			<tr>
				<td colspan="2" align="center">
					<button id="btnAdd" class="btn btn-success">가입</button>
