 ...
 * Generated at: 2021-04-05 03:57:17 UTC
...
public final class add_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/views/member/../include/include.jsp", Long.valueOf(1617545965178L));
    _jspx_dependants.put("/WEB-INF/views/member/../footer.jsp", Long.valueOf(1617549271024L));
    _jspx_dependants.put("/WEB-INF/views/member/../menu.jsp", Long.valueOf(1617545965393L));
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t//alert(result.yn);\r\n");
      out.write("\t\t\t\t\tif (result.yn=='y'){ //사용가능한 아이디 세팅\r\n");
      out.write("\t\t\t\t\t\t$('#idCheckYn').val('y');\r\n");
      out.write("\t\t\t\t\t}else{\r\n");
      out.write("\t\t\t\t\t\t$('#idCheckYn').val('n');\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t},\r\n");
      ...
      out.write("\t\t});\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t//가입버튼을 클릭했을때\r\n");
      out.write("\t\t$('#btnAdd').click(function(e) {\r\n");
      out.write("\t\t\te.preventDefault(); //기본이벤트 제거\r\n");
      out.write("\t\t\tconst userid = frmAdd.userid.value;\r\n");
      out.write("\t\t\tconst passwd = frmAdd.passwd.value;\r\n");
      out.write("\t\t\tconst email = frmAdd.email.value;\r\n");
      out.write("\t\t\tconst idCheckYn = frmAdd.idCheckYn.value; //아이디 중복 체크 여부\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\tconsole.log(userid);\r\n");
      out.write("\t\t\tconsole.log(passwd);\r\n");
      ...
      out.write("\t\t\t\tfrmAdd.passwd.focus();\r\n");
      out.write("\t\t\t}else if (email==''){\r\n");
      out.write("\t\t\t\talert('이메일을 입력해 주세요');\r\n");
      out.write("\t\t\t\tfrmAdd.email.focus();\r\n");
      out.write("\t\t\t}else if (idCheckYn!='y'){\r\n");
      out.write("\t\t\t\talert('아이디 중복 체크를 해주세요');\r\n");
      out.write("\t\t\t\tfrmAdd.btnIdCheck.focus();\r\n");
      out.write("\t\t\t}else{\r\n");
      ...
      out.write("\t\t});\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t//repasswd change이벤트\r\n");
      out.write("\t\t$('#repasswd').change(function() {\r\n");
      out.write("\t\t\tconst passwd = $('#passwd').val();\r\n");
      out.write("\t\t\tif (passwd != $(this).val()){\r\n");
      out.write("\t\t\t\talert('패스워드가 일치하지 않습니다.');\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");
      out.write("\t\t//사진이 변경됐을때 사진 보이기 \r\n");
      out.write("\t\t$('#imgfile').change(function() {\r\n");
      out.write("\t\t\tif(this.files && this.files[0]) {\r\n");
      out.write("\t\t\t    var reader = new FileReader;\r\n");
      out.write("\t\t\t    \r\n");
      out.write("\t\t\t    reader.onload = function(data) {\r\n");
      out.write("\t\t\t     $(\"#selectimg img\").attr(\"src\", data.target.result).width(100);        \r\n");
      out.write("\t\t\t    }\r\n");
      ...
      out.write("      <a class=\"navbar-brand\" href=\"\" id=\"aBoardList\">게시판</a>\r\n");
      out.write("      <a class=\"navbar-brand\" href=\"\" id=\"aInfo\">회사위치</a>\r\n");
      ...
      out.write("\t<form name=\"frmAdd\" action=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${path}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/member/add\" method=\"post\" enctype=\"multipart/form-data\" >\r\n");
      out.write("\t\t<table>\r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<th>아이디</th>\r\n");
      out.write("\t\t\t\t<td><input type=\"text\" name=\"userid\" size=\"10\" id=\"userid\">\r\n");
      out.write("\t\t\t\t\t<input type=\"hidden\" id=\"idCheckYn\"> <!-- value가 y이면 체크완료(사용가능) -->  \r\n");
      out.write("\t\t\t\t\t<input type=\"button\" value=\"중복체크\" id=\"btnIdCheck\" class=\"btn btn-dark\">\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<th>비밀번호</th>\r\n");
      out.write("\t\t\t\t<td><input type=\"password\" name=\"passwd\" id=\"passwd\">\r\n");
      out.write("\t\t\t\t<input type=\"password\" id=\"repasswd\"></td>\r\n");
      out.write("\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<th>이메일</th>\r\n");
      ...
      out.write("\t\t\t\t<td><input type=\"text\" name=\"zip\" size=\"5\"><button id=\"btnAddrFind\" class=\"btn btn-dark\">주소찾기</button> </td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t<tr>\r\n");
      ...
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<th>사진</th>\r\n");
      out.write("\t\t\t\t<td><input type=\"file\" name=\"imgfile\" id=\"imgfile\" class=\"btn btn-dark\">\r\n");
      out.write("\t\t\t\t\t<div id =\"selectimg\"> <img src=\"\"></img></div>\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t </td>\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t</tr>\r\n");
      ...
      out.write("\t\t\t\t\t<button id=\"btnAdd\" class=\"btn btn-success\">가입</button>\r\n");
      out.write("\t\t\t\t\t<input type=\"reset\" value=\"취소\" class=\"btn btn-danger\">\r\n");
      out.write("\t\t\t\t\t<button id=\"btnMain\" class=\"btn btn-primary\">메인으로</button>\r\n");
      out.write("\t\t\t\t\t<a href=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${apiURL}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("\"><img height=\"50\" src=\"http://static.nid.naver.com/oauth/small_g_in.PNG\"/></a>\r\n");
      out.write("\t\t\t\t</td>\r\n");
      ...
      out.write("  <p>허현규의 게시판 <a href=\"https://www.naver.com\">gusrb1954@naver.com</a></p> \r\n");
      out.write("</footer>");
      out.write("\t\r\n");
      out.write("</body>\r\n");
      out.write("</html>");
  ...
  private boolean _jspx_meth_c_005fset_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/member/../include/include.jsp(4,0) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fset_005f0.setVar("path");
      // /WEB-INF/views/member/../include/include.jsp(4,0) name = value type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
      _jspx_th_c_005fset_005f0.setValue(new org.apache.jasper.el.JspValueExpression("/WEB-INF/views/member/../include/include.jsp(4,0) '${pageContext.request.contextPath}'",_jsp_getExpressionFactory().createValueExpression(_jspx_page_context.getELContext(),"${pageContext.request.contextPath}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
